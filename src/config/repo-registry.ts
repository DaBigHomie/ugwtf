...
export const REPOS: Record<string, RepoConfig> = {
  ...
  // ---------------------------------------------------------------------------
  // Extended workspace repos — registered by workspace-gap-remediation [FI-01]
  // ---------------------------------------------------------------------------

  'agent-mastery': {
    slug: 'DaBigHomie/agent-mastery',
    alias: 'agent-mastery',
    framework: 'node',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    ...
    e2eCommand: null,
    extraLabels: [],
    localPath: `${HOME}/management-git/agent-mastery`,
    ci: {
      lintCommand: null,
      typeCheckCommand: 'tsc --noEmit',
      buildCommand: null,
  ...
  atl: {
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'bookings', color: 'f97316', description: 'Table booking features' },
    ],
  ...
  'tequila-week': {
    slug: 'DaBigHomie/atl-tequila-week',
    alias: 'tequila-week',
    framework: 'vite-react',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    ...
    e2eCommand: 'npx playwright test',
    extraLabels: [
      { name: 'events', color: 'ff6f61', description: 'Event features' },
    ],
    localPath: `${HOME}/management-git/atl-tequila-week`,
    ci: {
      lintCommand: 'eslint .',
      typeCheckCommand: null,
      buildCommand: 'vite build',
  ...
  'audit-orch': {
    slug: 'DaBigHomie/audit-orchestrator',
    alias: 'audit-orch',
    framework: 'node',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'audit', color: '7c3aed', description: 'Audit pipeline features' },
    ],
    localPath: `${HOME}/management-git/audit-orchestrator`,
    ci: {
      lintCommand: null,
      typeCheckCommand: 'tsc --noEmit',
      buildCommand: null,
  ...
  'chat-exporter': {
    slug: 'DaBigHomie/copilot-chat-exporter',
    alias: 'chat-exporter',
    framework: 'node',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    ...
    e2eCommand: null,
    extraLabels: [],
    localPath: `${HOME}/management-git/copilot-chat-exporter`,
    ci: {
      lintCommand: null,
      typeCheckCommand: null,
      buildCommand: null,
  ...
  'docs-standards': {
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'standards', color: '0075ca', description: 'Workspace standards update' },
    ],
  ...
  haven: {
    slug: 'DaBigHomie/haven-event-siteplan',
    alias: 'haven',
    framework: 'vite-react',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'events', color: 'ff6f61', description: 'Event planning features' },
    ],
    localPath: `${HOME}/management-git/haven-event-siteplan`,
    ci: {
      lintCommand: 'eslint .',
      typeCheckCommand: null,
      buildCommand: 'vite build',
  ...
  'image-gen': {
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'image-pipeline', color: '6366f1', description: 'AI image generation pipeline' },
    ],
  ...
  'jay-anthony': {
    slug: 'DaBigHomie/jay-anthony-app',
    alias: 'jay-anthony',
    framework: 'vite-react',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    ...
    e2eCommand: 'npx playwright test',
    extraLabels: [],
    localPath: `${HOME}/management-git/jay-anthony-app`,
    ci: {
      lintCommand: 'eslint .',
      typeCheckCommand: null,
      buildCommand: 'vite build',
  ...
  management: {
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'workspace', color: '0284c7', description: 'Workspace-level management' },
    ],
    localPath: `${HOME}/management-git/Management`,
    ci: {
      lintCommand: null,
      typeCheckCommand: null,
      buildCommand: null,
  ...
  oros: {
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'creative-economy', color: '6366f1', description: 'Creative economy platform features' },
    ],
    localPath: `${HOME}/management-git/oros-core`,
    ci: {
      lintCommand: 'next lint',
      typeCheckCommand: 'tsc --noEmit',
      buildCommand: 'next build',
  ...
  'product-gen': {
    slug: 'DaBigHomie/product-generator',
    alias: 'product-gen',
    framework: 'vite-react',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'ecommerce', color: 'f8b4d9', description: 'Ecommerce product features' },
    ],
    localPath: `${HOME}/management-git/product-generator`,
    ci: {
      lintCommand: 'eslint .',
      typeCheckCommand: null,
      buildCommand: 'vite build',
  ...
  'tequila-festival': {
    slug: 'DaBigHomie/tequila-sunrise-festival-atl',
    alias: 'tequila-festival',
    framework: 'vite-react',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    supabaseServiceKeySecret: null,
    ...
    e2eCommand: 'npx playwright test',
    extraLabels: [
      { name: 'events', color: 'ff6f61', description: 'Festival event features' },
    ],
    localPath: `${HOME}/management-git/tequila-sunrise-festival-atl`,
    ci: {
      lintCommand: 'eslint .',
      typeCheckCommand: null,
      buildCommand: 'vite build',
  ...
  'unique-collab': {
    ...
    e2eCommand: 'npx playwright test',
    extraLabels: [
      { name: 'boutique', color: 'f8b4d9', description: 'Boutique marketplace features' },
    ],
    localPath: `${HOME}/management-git/unique-collab`,
    ci: {
      lintCommand: 'eslint .',
      typeCheckCommand: null,
      buildCommand: 'vite build',
  ...
  'workflow-agents': {
    slug: 'DaBigHomie/damieus_workflow_analysis',
    alias: 'workflow-agents',
    framework: 'node',
    supabaseProjectId: null,
    supabaseUrlSecret: null,
    supabaseServiceKeySecret: null,
    ...
    e2eCommand: null,
    extraLabels: [
      { name: 'workflow-analysis', color: '7c3aed', description: 'Workflow analysis tooling' },
    ],
    localPath: `${HOME}/management-git/damieus-workflow-agents`,
    ci: {
      lintCommand: null,
      typeCheckCommand: null,
      buildCommand: null,
