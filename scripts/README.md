...
|--------|---------|-------|
| `advance-chain.mts` | Advance prompt chain to next step; marks completed, triggers next | `npx tsx scripts/advance-chain.mts projects/043/prompt-chain.json` |
...
| `create-chain-issues.mts` | Create GitHub issues from prompt-chain.json | `npx tsx scripts/create-chain-issues.mts projects/043/prompt-chain.json` |
...
| `wave-runner.mts` | Execute prompt chain waves (batches of parallel prompts) | `npx tsx scripts/wave-runner.mts projects/043/prompt-chain.json` |
