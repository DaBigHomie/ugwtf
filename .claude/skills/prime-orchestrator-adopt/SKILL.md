...
description: >-
  ...
  next BG-XXXX tag; optionally backfills a concern into the queue. Use at
  session start when the work is not yet tracked in CORTEX. Triggers:
  "/prime-orchestration-adopt", "adopt primeo", "primeO session-init",
  "start a primeO session for un-queued work".
...
- 2026-07-10 — Initial. Fills the session-init gap between fresh session
  start and the standing-menu discipline required by
