...
2. Architecture completeness checklist (ALL must be ✅ or an explicit, justified N/A):
...
3. Output a VALIDATION block: each item ✅/❌/N-A with a one-line note. Any ❌ → fix before Phase 3.
